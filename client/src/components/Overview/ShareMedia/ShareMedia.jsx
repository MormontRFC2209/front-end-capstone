      ...
      <div id="share-product">
        ...
        <div id="share-icon-container" className="overview">
          <div data-href={window.location.origin}>
            <a target="_blank" href={`https://www.facebook.com/sharer/sharer.php?u=${siteLink}&amp;src=sdkpreparse`} aria-label="share on Facebook">
              <i className="overview fa-brands fa-square-facebook fa-2xl share-icon facebook"></i>
            </a>
          </div>

          <a href={"https://twitter.com/intent/tweet?text=Check%20out%20" + siteLink} aria-label="share on Twitter">
            <i className="overview fa-brands fa-square-twitter fa-2xl share-icon twitter"></i>
          </a>

          <a href={"https://pinterest.com/pin/create/button/?url=" + siteLink + "&media=" + stylePhoto + "&description=Come%20visit%20our%20site!"} aria-label="share on Pinterest">
